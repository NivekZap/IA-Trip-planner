...
const data = [

    {
        ...
        category: "Paris, Francia",

        title: "Explora la ciudad de la luz  –  la Torre Eiffel, los campos eliseos y mas",
...

    {
        ...
        category: "Nueva York, USA",

        title: "Experiencia en Nueva York – Times Square, Central Park, Broadway",
...

    {
        ...
        title: "Descubre Tokio – Shibuya, los arboles de sakura y Templos",
